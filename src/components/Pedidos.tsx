...
import { Plus, Trash2, LayoutGrid, List, ShoppingCart, Edit } from 'lucide-react';
...
const Pedidos = () => {
  const { pedidos, clientes, produtos, createPedido, itensPedido, updatePedidoStatus, updatePedido, deletePedido } = useStore();
  ...
  const handleEditSubmit = (e: React.FormEvent) => {
    ...
    updatePedido(editingPedido.id, {
      cliente_id: editFormData.cliente_id,
      valor_total: parseFloat(editFormData.valor_total),
